...
class MobileAlohaPlaceTask(RLTask):
    def __init__(
        self,
        name,
        sim_config,
    ...
    def get_franka(self,):
        franka = MobileAloha(prim_path=self.default_zero_env_path + "/aloha", name="aloha")
    ...
    def init_data(self) -> None:
        ...
        hand_pose = get_env_local_pose(self._env_pos[0], UsdGeom.Xformable(stage.GetPrimAtPath("/World/envs/env_0/aloha/fl_link6")), self._device)
        lfinger_pose = get_env_local_pose(
            self._env_pos[0], UsdGeom.Xformable(stage.GetPrimAtPath("/World/envs/env_0/aloha/fl_link7")), self._device
        )
        rfinger_pose = get_env_local_pose(
            self._env_pos[0], UsdGeom.Xformable(stage.GetPrimAtPath("/World/envs/env_0/aloha/fl_link8")), self._device
        )
        # finger pos
